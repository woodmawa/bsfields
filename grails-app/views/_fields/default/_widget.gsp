<%@ page import="org.grails.datastore.mapping.model.types.Basic; org.grails.datastore.mapping.model.PersistentEntity; org.grails.datastore.mapping.model.types.Association; com.softwood.domain.Holder" %>
...
<g:elseif test="${pageScope.variables.persistentProperty && pageScope.variables.persistentProperty instanceof org.grails.datastore.mapping.model.types.OneToMany}" >
            <div class="input-group text col-sm-8"  >
                <%
                    org.grails.datastore.mapping.model.types.Association prop = pageScope.variables.persistentProperty
                    org.grails.datastore.mapping.model.PersistentEntity entity = prop.getAssociatedEntity()
                    Class referencedPropertyType
                    def referencedPropertyList
                    if (entity) {
                        referencedPropertyType = entity.getJavaClass()
                        referencedPropertyList = referencedPropertyType.list()
                    } else {
                        //assume its basic type
                        referencedPropertyType = ((org.grails.datastore.mapping.model.types.Basic) prop).getComponentType()
                        referencedPropertyList = ["help"]
                ...
                <div class="input-group-append dropdown dropright" >
                    ...
                    <g:select optionKey="id" from="${referencedPropertyList}" multiple="true" name="${property}" noSelection="${['null':'Select One...']}" value="${property}"/>
