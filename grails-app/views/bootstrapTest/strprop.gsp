...
<p>bsf:field strProp</p>
<bsf:field bean="${this.pageScope.bootstrapTest}" property="strProp">
    <p>howdi</p>
    <%--<g:render template="/_fields/string/displayWidget" ></g:render> --%>
</bsf:field>

<p>bsf:field ldtProp</p>
<bsf:field bean="${this.pageScope.bootstrapTest}" property="ldtProp">
    <g:render template="/_fields/localDateTime/displayWidget" ></g:render>
</bsf:field>

<p>bsf:field mapProp</p>
<bsf:field bean="${this.pageScope.bootstrapTest}" property="mapProp">
    <g:render template="/_fields/map/displayWidget" ></g:render>
</bsf:field>

<hr />

<p>use bsf:display tag </p>
